...
/*
 ...
 position 'start' or FEN String or Position Object
 
 
 🪧 onChange Fires when the board position changes.
 ...
 🪧 onDragStart Function Fires when a piece is picked up.
 ...
 🪧 onDragMove Fires when a dragged piece changes location.
 ...
 🪧The first argument to Chessboard() must be an ID or a single DOM node.
